...
ABOUT:
The tournament.py and tournament.sql create the database, tables, and function calls necessary to facilitate a swiss tournament according to the tests designed in the tournament_test.py file. 
